    ...
    <div className='px-8'>
      ...
      {/* Available Changing Option */}
        <div className='pb-6 pt-1 flex justify-between items-center'>
            <h1 className='text-2xl font-bold'> {selectedType ===  `available` ? `Available Players` : `Selected(${selectedPlayer.length}/${player.length})`}</h1>
      ...
      <div>
        {
          ...
          : <SelectedPlayers player={player} selectedPlayer={selectedPlayer} />
        }
      </div>
    </div>
  )
